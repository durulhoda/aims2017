...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var n=p&&p.scroller_images_height?p.scroller_images_height:"130";
        ...
        function s_s_nav(a,d){
            var b=a.children(".arrow:first");
            var c=a.children(".arrow:last");
            a.children(".arrow").css("width","25px");
            a.children(".arrow").css("height","50px");
            a.children(".arrow").css('background-image','url("'+d+'/arrow.gif")');
            c.css('background-position','right top');
            a.children(".arrow").css('background-repeat','no-repeat');
            c.css('right','0px');
            b.css('left','0px');
        }
    }
