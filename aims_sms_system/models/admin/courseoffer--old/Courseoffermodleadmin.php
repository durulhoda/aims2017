...
//        $this->db->select('campusName');        
    ...
    public function getcourseOfferId($arry){
        $this->db->select('*');
        $this->db->where('programOfferId',$arry['programOfferId']);
...
//        $this->db->select('campusName');        
  ...
  public function searchcourseassignlist($data){
    ...
    public function deleteCourseofferInfo($id) {
      ...
      public function duplicateCourseofferInfo($programOfferId,$courseId){
      ...
      $user_check = $this->db->get_where($this->_table, array(
        ...
        $this->db->select('cou_offer.*,cour.*')
                ->from('courseoffer cou_offer');        
        $this->db->join('course cour', 'cour.courseId= cou_offer.courseId');          
        $qu = $this->db->get_where($this->_table, array('cou_offer.courseId' => $id,'cou_offer.programOfferId' => $test));
        $result=$qu->row_array(); 
        if(!empty($result))
        {
            return $result;
     ...
     public function getMarkDevidevalue($data) {
      ...
      public function getofferedtttt($courseId,$programOfferId){
       ...
       // $this->db->join('course cour', 'cour.courseId= cou_offer.courseId');          
        ...
        $qu = $this->db->get_where($this->_studentmarks, array('courseId' => $courseId,'programOfferId' => $programOfferId,'semesterId' => $semesterId,'examtypeId' => $examtypeId,'studentId' =>$studentId));
