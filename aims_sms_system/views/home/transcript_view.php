...
<div style="margin: 10px auto;width: 850px;border: 0px solid #cccccc;border:1px solid #d9d9d9;background-color:white !important;">
<table style="width:100%; border-bottom: 2px solid #ddd; margin-bottom: 3px">
    ...
    <tr style=" font-family: cambria;">
        <td style="text-align: center;">
            ...
            <img src="<?php echo $logo; ?>" style="margin-top:3px;width:80px;" height="80" />
    ...
    <tr>
        <td style="text-align: center; ">
            ...
            <h4 style="font-family: century gothic;color:green;"><?php echo getSemesterName($semester_id)."' ".$program_info->session_name; ?></h4>
        </td>
    </tr>
    </tbody>
</table>
...
<div style="margin: 10px 10px 20px; font-family: cambria; height: 170px; width:98%; border:0px solid red;">
    <table style="margin-left:5px;width:50%;margin-bottom:10px; float: left;border:0px solid red; line-height: 3px;">
        <tbody>
        <tr>
...
<table class="detailsTable" style=" font-family: cambria; margin: 10px 10px; width: 97%; border-collapse: collapse;line-height: 20px;" id="tblprint">
    <thead>
...
//                          print_r($merge[$val['merge_id']]);
            // }
            ?>
            <tr style="border: 2px solid #D8D8D8; ">
...
<div style="">
    <table class="table table-bordered" style=" font-family: cambria; margin: 10px 10px; width: 60%; border-collapse: collapse;float: left;" id="">
        ...
        <tr>
            <td>Grand Total(Com+Add+Con)</td>
            <td><b><?php echo $records['total']['grand_total_marks_full']; ?></b></td>
            <td><b><?php echo $records['total']['grand_total_marks']; ?></b></td>
        </tr>
        </tbody>
    </table>
    <table class="table table-bordered" style="margin-right:16px; font-family: cambria; width: 27%; border-collapse: collapse;float:right;" id="">
        <tbody>
        <trstyle="background-color: lightgrey !important;">
            ...
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b><?php echo $records['total']['gpa_point']; ?></b></td>
        </tr>
        <tr>
           <td  style="text-align: left; ">
               <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b>Letter Grade</b></td>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b><?php echo $records['total']['gpa_letter']; ?></b></td>
        </tr>
        <tr>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b>Percentage Marks</td>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><?php echo round(($records['total']['total_marks_common_final'] * 100)/$records['total']['total_marks_common_full'])."%"; ?></td>
        </tr>
        <tr>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;">Failed Subject</td>
            <td  style="text-align: left; ">
                <span class="color_red" style="font-size: 18px; font-family: Segoe UI Semibold;"><?php echo $records['total']['tot_fail_subj']; ?></td>
        </tr>
        </tbody>
    </table>
</div>
<table style="margin-top:5px; font-family: cambria; border-collapse: collapse;">
    <tr>
        <td colspan="12" style="margin-left:10px;padding:10px 10px 5px;text-align: left; font-size: 14px; font-weight: bold;"><span style="color:green;">Student Position</span> : <?php echo $records['total']['position']; ?></td>
...
<table style=" font-family: cambria; margin: 10px 10px; width: 97%; border-collapse: collapse;">
    <?php if ($records['total']) : ?>
        <tbody>
        <tr>
            <td colspan="12" style="padding:10px 0px 5px;text-align: left; font-size: 16px; font-weight: bold;">

                &nbsp;&nbsp;Remarks: <?php echo $records['total']['result_comment']; ?>
            </td>
        </tr>
        <tr>
            <td colspan="4" style="padding:10px 0px 10px 10px;text-align: left; font-size: 12px; font-weight: bold;"><img style="position:relative;margin-left:1%;width: 140px;height: 45px;" src="<?php echo base_url()."images/ct.png"; ?>"> <br>.............................................<br>Class Teacher </td>
            <!--<td colspan="4" style="padding:10px 10px 10px 0px;text-align: right; font-size: 12px; font-weight: bold;"><img style="position:relative;margin-left:25%;width: 140px;height: 45px;" src="<?php echo base_url()."images/ec.png"; ?>"><br> <span style="margin-right:8px;">.............................................</span><br> <span style="margin-right:22px;">Exam Controller</span> </td>-->
            <td colspan="4" style="padding:10px 10px 10px 0px;text-align: right; font-size: 12px; font-weight: bold;"><img style="position:relative;margin-left:50%;width: 140px;height: 45px;" src="<?php echo base_url()."images/au.png"; ?>"> <br>.............................................<br> Authorized Signature </td>
        </tr>
        </tbody>
    <?php endif; endif; ?>
    <?php
