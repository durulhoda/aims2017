            ...
            <article class="s-12 m-7 l-8">
                ...
                <div class="adjbox">                                                                                                                                                                         
                    <div id="jssor_1" class="nslider">
                        ...
                        <div data-u="slides" class="sliderimg">
                            ...
                            if (!empty($sliderphoto)) {
                                foreach ($sliderphoto as $value) {
                                    ?>  
                                    <div data-p="112.50">
                                        <img data-u="image" src="<?php echo base_url() . "/" . $value->image; ?>" />
                                    </div>
                        ...
                        <!-- Bullet Navigator -->
                        <div data-u="navigator" class="jssorb01" style="top: 336px;left:16px;">
                            ...
                            foreach ($getupnoticedata as $value) {
                                ...
                                <div style="background: #eee; padding: 4px; margin-top:5px; border-radius: 4px;"> 
                                    <a  href="<?php echo base_url(); ?>home/ViewAcademicInformation/<?php echo $value['id'] ?>">
                                        Next Event:      <span class="dte">     <?php $limit = character_limiter($value['title'], 40);
                        echo $limit;
                                ?></span> </a>
                                </div>
                                <div style="float: left; padding: 6px; width: 34%;">
                                ...
                                <div style="float: left; width:46%; height:125px; margin-top:8px;">
                                    ...
                                    <div style="background: #eee; padding: 4px; border-radius: 4px;  margin-top: 6px;">
                                        <font size="3px">Date: </font>  <a  href="<?php echo base_url(); ?>home/ViewAcademicInformation/<?php echo $value['id'] ?>">  
...
<!-- Update Notice Marquee start from--->
    ...
    <div class="box margin-bottom">
        <div class="margin">
            ...
            <article class="s-12 m-7 l-8">
                ...
                <iframe width="100%" height="240" src="https://www.youtube.com/embed/pBQNxH44Bzk" frameborder="0" allowfullscreen></iframe>
            </article>
            <!-- ASIDE NAV -->
            <div class="s-12 m-5 l-4">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="http://www.jessoreboard.gov.bd/" target="_blank">Jessore Education Board</a></li>
                                ...
                                <li><a href="http://www.mymensingheducationboard.gov.bd/" target="_blank">Mymensingh Education Board</a></li>
...
if (!empty($getphotodata)) {
    ...
    foreach ($getphotodata as $value) {
        ?>
            ...
            echo base_url() . "demo_1/img/default.jpg";
        } ?>" alt="image"/>
