                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                                <div class="box-header well" data-original-title>
                                    <h2><i class="icon-edit"></i> Add Academic Content Information</h2>
                                    <div class="box-icon">
                                ...
                                <div class="box-content">
                                    ...
                                    <form name="example" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/saveacademiccontent" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            <legend>Add Academic Content</legend>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label" for="textarea1">Upload File</label>
                                                <div class="controls">
                                                    <input name = "file" class="button3" type = "file" />   Upload                                                
                                                </div>
                                            </div>
                                             ...
                                             <div class="control-group">
                                                ...
                                                <div class="controls">
                                                      <input name="eventdate" class="button3" type="text" />
                                                </div>
                                            </div> 
