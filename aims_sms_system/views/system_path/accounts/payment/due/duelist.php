...
<div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo acc_Url(); ?>/payments/duesearch" method="post" class="form-horizontal" role="form">
            ...
            <div class="col-xs-12">
               <div class="widget-box">
                 ...
                 <div class="col-xs-12">
                     ...
                     <button class="btn btn-danger btn-block">Total Due : <?php echo ($totalfees + $fineamount) - $totalamount; ?> /- </button>
