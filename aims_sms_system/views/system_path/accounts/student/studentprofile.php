                    ...
                    <div class="col-sm-9 widget-container-col">
                                        ...
                                        <div id="p_info" class="tab-pane in active">
                                            <div class="profile-user-info profile-user-info-striped">
                                                ...
                                                <div class="profile-info-row">
                                                    ...
                                                    <div class="profile-info-value">
                                                        <span class="editable" id="login"><?php if (!empty($editData["quata_id"])) {
                                                            echo getQuataName($editData["quata_id"]);
                                                        } ?></span>
                                                    </div>
                                                </div>
                        ...
                        echo $editData["permanentAddress"];
                                        ...
                                        <div id="g_info" class="tab-pane">
                                            <form class="form-horizontal" role="form" action="<?php echo acc_Url();?>/Student/searchresults" enctype="multipart/form-data" method="post" target="_blank">
                  ...
                  <div class="clearfix form-actions">
                     <div class="col-md-12">
                        <button class="btn btn-success" type="submit" name="search">
                         ...
                         <input type="hidden" name="data[studentId]" value="<?php if (!empty($editData['studentId'])) { echo $editData['studentId']; } ?>">
                                          </div>
                 </div>
            </div> <br><br><br><br><br>
                                        </form>    
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="center">
                                ...
                                <?php if(!empty($value['category'])){    echo element($value['category'],  getprevcatInfo(),Null);}?>
                            </td>
                         
                             <td class="center">
                                <?php if($value['roll']) {echo $value['roll'];} ?>
                            </td>
                             <td class="center">
                                <?php if($value['thana_registration']) {echo $value['thana_registration'];} ?>
                            </td>
                             <td class="center">
         
                                 <?php if (!empty($value['board'])) { echo element($value['board'],getBoardInfo(),Null); } ?>
                            </td>
                             <td class="center">
                                <?php if($value['gpa']) {echo $value['gpa'];} ?>
                            </td>
                             <td class="center">
                                <?php if($value['passing_year']) {echo $value['passing_year'];} ?>
                            </td>
                                ...
                                <?php }?>
                                     ...
                                     <?php }?>                </table>
                                        ...
                                        <div id="c_info" class="tab-pane">
                                            ...
                                            <form action="<?php echo acc_Url(); ?>/paymentadd/searchpaymentlist" method="post">
