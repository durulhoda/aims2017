				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
                                                                    <span class="green">Adventure-Soft Ltd.</span>
                                                                </h1>        
                                                                <h4> <span class="red" id="id-text2">Institute Accounts System</span> </h4>	
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<h4 class="header green lighter bigger">
												Input Your Access Information
											</h4>

											<div class="space-6"></div>

                                                                                        <form action="<?php echo acc_Url(); ?>/login" method="post"> 
												...
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" name="loginvalue" class="width-35 pull-right btn btn-sm btn-success">
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='<?php echo base_url(); ?>all_tools/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
