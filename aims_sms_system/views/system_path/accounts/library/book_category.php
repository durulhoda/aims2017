...
<div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo acc_Url(); ?>/bookcategory/insertbookcategory" method="post" class="form-horizontal" role="form">
        ...
        <?php echo getSelfNames($val['selfId']); ?>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs btn-group">
                                                ...
                                                <a href="<?php echo acc_Url(); ?>/bookcategory/editbookcategory/<?php echo $val['bookcategoryId']; ?>"  class="btn btn-xs btn-info">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>

                                                <a href="<?php echo acc_Url(); ?>/bookcategory/deletebookcategory/<?php echo $val['bookcategoryId']; ?>" class="btn btn-xs btn-danger">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                <div class="inline pos-rel">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                        ...
                                                        <li>
                                                            <a href="<?php echo acc_Url(); ?>/bookcategory/editbookcategory/<?php echo $val['bookcategoryId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                <span class="green">
                                                        ...
                                                        <li>
                                                            <a href="<?php echo acc_Url(); ?>/bookcategory/deletebookcategory/<?php echo $val['bookcategoryId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                <span class="red">
                                                                    <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                </span>
                                                            </a>
