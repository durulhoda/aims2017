                        ...
                        <div class="widget-main padding-24">
                            ...
                            <div>          
                                ...
                                <table class="table table-striped ">
                                    ...
                                    foreach ($report_list as $valuex) {
                                          
                                            if($valuex['financeCategory']==1)
                                            {
                                                if($s==1)
                                                {                
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                 ...
                                                 if(!empty($financeCategory) || (empty($financeCategory) && empty($financeHead)))
                                                 {
                                ...
                                <table class="table table-striped ">
                                    ...
                                    <?php
                                      ...
                                      //      $credittotal = 0;
                                          ...
                                          foreach ($report_list as $exluex) {
                                                if($exluex['financeCategory']==2)
                                                {
                                                    if($sl==1)
                                                    {
                                        ?> 
                                        ...
                                        <tbody>
                                            <?php
                                                 foreach ($report_list as $xp_value) {
                                                     if($xp_value['financeCategory']==2)
                                                     {
                                                    
                                                            $studentpayment = $totalpaidamount;
                                                           // $debittotal = $value['debit'] + $debittotal;
                                                            $debittotal = $xp_value['debit'] + $debittotal;
                                            ?>
                                            <tr>
                                                <td class="text-left">    <?php echo getIncomeHeadCategoryName($xp_value['financeHead']) ?></td>

                                                <td class="text-right">
                                                    <?php 
                                                         $xld=explode(".",$xp_value['debit']);
                                                         if(!empty($xld[1])){ echo $xp_value['debit']; }
                                                         else{ echo $xp_value['debit'].".00"; }
                                                    ?>
                                                </td>
                                            </tr>  
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><span class="header bolder ">
                                                    <?php $totalcredit = $debittotal + $studentpayment; 
                            ...
                            <?php
                                if(!empty($totalcredittotal) && !empty($totalcredit))
                                {
