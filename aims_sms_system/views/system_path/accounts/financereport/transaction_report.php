            ...
            <div class="tabbable">      
                ...
                <div class="tab-content">
                    ...
                    <div id="tab1" class="tab-pane active">
                        <form class="form-horizontal"  action="<?php echo acc_Url(); ?>/financeReport/searchreport" method="post" role="form">
                           <div class="clearfix"> 
                             <span class="col-sm-4">
                    ...
                    <div id="tab2" class="tab-pane">
                        <form class="form-horizontal"  action="<?php echo acc_Url(); ?>/financeReport/class_paymentreport" method="post" role="form">
                           <div class="clearfix"> 
                               <span class="col-sm-4">
                                ...
                                <select required name="data[headId]" class="form-control">
                                    <option value=""></option> 
                                ...
                                <span class="col-sm-4">
                                    <label class="control-label" for="form-field-1">From Date &nbsp; <?php echo form_error('data[from_date]', '<span class="successMessage">', '</span>'); ?></label>
                                    <input class="form-control date-picker" id="id-date-picker-1" required="1"  placeholder="dd/mm/yyyy" name="data[from_date]" value="<?php echo set_value("data[from_date]"); ?>" type="text" id="form-field-mask-1" />
                                </span>
                                <span class="col-sm-4">
                                    <label class="control-label" for="form-field-1">To Date &nbsp; <?php echo form_error('data[to_date]', '<span class="successMessage">', '</span>'); ?></label>
                                    <input class="form-control date-picker" id="id-date-picker-1" required="1"  placeholder="dd/mm/yyyy" name="data[to_date]" value="<?php echo set_value("data[to_date]"); ?>" type="text" id="form-field-mask-1" />

                                </span>
                               <span class="col-xs-10 col-sm-4">
                                   <label class="control-label" for="form-field-1">Information Type &nbsp; <?php echo form_error('data[info_type]', '<span class="successMessage">', '</span>'); ?></label>
                                   <select name="data[info_type]"  class="form-control">
