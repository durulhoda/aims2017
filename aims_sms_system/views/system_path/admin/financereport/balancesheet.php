...
<div class="row">
    ...
    <div class="col-sm-12">
        <div class="tabbable">
            <ul id="myTab4" class="nav nav-tabs padding-22 tab-color-blue background-blue ">
                <li class="">
                    <a href="#home4" data-toggle="tab" aria-expanded="true">Balance Sheet</a>
                </li>
            ...
            <div class="tab-content">
                ...
                <div id="home4" class="tab-pane active">
                        ...
                        <form class="form-horizontal" role="form" action="<?php echo admin_Url(); ?>/financeReport/balanceReport" enctype="multipart/form-data" method="post">
