...
<div id="printableArea" >
    ...
    <div style="margin: 10px auto; width: 550px;  border: 0px solid #cccccc; display: inline-block;" > 
        <div style=" border: 1px solid #d9d9d9; height: 330px;">      
            <div>   
                <span></span><table style="width:100%; border-bottom: 2px solid #ddd; margin-bottom: 3px">
                    ...
                    <span style="width:100%; border-bottom: 1px solid #ddd; margin-bottom: 1px">
                            <h4 style="font-family: Algerian;text-align: center;">Seat</h4> 
                    </span> 
                   
                    <div style='margin: -1px 10px 10px; font-family: cambria; height: 60px; width:98%; border:1px solid #E8E8E8;'>
                       
                        <div align="center">
                            <span><h5>Application ID : <b class="red"><?php echo $info['applicationId'];?></b>, Roll No. : <b class="red"><?php echo $info['roll_no'];?></b></h5></span><p></p>
                            <span ><h4><b class="blue"><?php echo $info['firstName'];?></b></h4></span>
                        </div>
                    </div>
                    
                    <table  style="width:74%; float: left; border: 4px solid #eee; margin-right: 1px; border-collapse: collapse;margin-left:69px;margin-top: 0px; height: 30px;">
