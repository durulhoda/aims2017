<!-- /Content Section  -->                    
        ...
        <h1>
          Admit Card Information
            <small class="red">
                ...
                Student Admit Card Information
            </small>
        </h1>
    </div><!-- /.page-header -->
    ...
    <div class="row">
        <?php
            ...
            ?>              
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/courseoffer/searchadmitcard" method="post">
                <div class="col-xs-12 col-sm-12">  
                    ...
                    <!-- <div class="col-xs-10 col-sm-4">
                        <label class="control-label" for="form-field-1">Exam Type</label>
                        <select id="getexamtype" name="data[examtype]" required="1" class="form-control">
                            <option value="0">Select</option>
                            <?php// foreach($examtype as $examtype){?>
                            <option value="<?php// echo $examtype['examtypeId'];?>"><?php// echo $examtype['examtypeName'];?></option>
                            <?php// }?>
                        </select>
                    </div> -->
                </div>
