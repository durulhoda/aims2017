                            ...
                            <div class="modal-content">
                                <div class="modal-header no-padding">
                                    <div class="table-header">
                                        ...
                                        Generate Transfer Certificate By Individual Student
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="modal-body no-padding">

                                        <form class="form-horizontal" role="form" action="<?php echo admin_Url(); ?>/Certificate/genrttransfercertificate" method="post">
                                            <div class="col-xs-12 col-sm-12">  
                                                <!-- PAGE CONTENT BEGINS -->
