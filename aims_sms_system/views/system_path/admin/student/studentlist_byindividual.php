                            ...
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="modal-body no-padding">
                                        ...
                                        <form class="form-horizontal" role="form" action="<?php echo admin_Url(); ?>/student/searchindividualStudent" method="post">
                                            <div class="col-xs-12 col-sm-12">  
                                                <!-- PAGE CONTENT BEGINS -->
                                                <div class="col-xs-10 col-sm-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs action-buttons">
                                    ...
                                    <a class="red" onclick="return checkDelete('Student ?');" href="<?php echo admin_Url();?>/student/deleteStudentData/<?php echo $value['studentId']; ?>" title="Delete">
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        ...
                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                            <li>
                                                <a href="<?php echo admin_Url();?>/student/viewstudentInfo/<?php echo $value['studentId']?>/<?php echo $value['programOfferId']?>" class="tooltip-info" data-rel="tooltip" title="View">
                                                    <span class="blue">
                                            ...
                                            <li>
                                                <a onclick="return checkDelete('Student ?');" href="<?php echo admin_Url();?>/student/deleteStudentData/<?php echo $value['studentId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                    <span class="red">
