<!-- /Content Section  -->                    
    ...
    <div class="row">
        <?php
            ...
            ?>
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/student/getstudentid" enctype="multipart/form-data" method="post">
                   ...
                   <div class="col-xs-12 col-sm-12">  
                    ...
                    <div class="col-xs-12">
                        <div class="clearfix form-actions">
                            <div class="col-md-12">
                                <button class="btn btn-success" name="search_idcard" type="submit">
