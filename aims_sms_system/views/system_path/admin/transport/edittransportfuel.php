    ...
    <div class="page-header">
        <h1>
            ...
            <small class="red">
               ...
               Edit Transport Fuel Information
            </small>
        </h1>
    </div><!-- /.page-header -->
...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/transportfuel/updateTransportFuel/<?php echo $editData['transportfuelId'];?>" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data[fuelCost]" value="<?php echo $editData['fuelCost']; ?>"  id="form-field-1" placeholder="Enter Transport Fees" class="col-xs-8 col-sm-3" />
