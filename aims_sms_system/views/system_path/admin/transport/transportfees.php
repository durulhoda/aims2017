...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/transportfees/inserttransportfees" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <select name="data[rootId]" class="col-xs-9 col-sm-3" class="form-control">
                        <option value="">Select</option>
                        <?php foreach (getTransportRootList() as $values) { ?>
                            <option value="<?php echo $values['rootId']; ?>" 
                                    <?php echo set_select('data[rootId]', $values['rootId'], FALSE) ?>>
                                        <?php echo $values['transportRoot']; ?>
                            </option>
                        <?php } ?>
                    </select>  
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data[transportFees]"  id="form-field-1" placeholder="Enter Transport Fees" class="col-xs-8 col-sm-3" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs btn-group">
                                         ...
                                         <a href="<?php echo admin_Url();?>/transportfees/editTransportfees/<?php echo $val['transportfeesId']; ?>" class="btn btn-xs btn-info">
                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                        </a>

                                        <a href="<?php echo admin_Url();?>/transportfees/deleteTransportfees/<?php echo $val['transportfeesId']; ?>" class="btn btn-xs btn-danger">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/transportfees/editTransportfees/<?php echo $val['transportfeesId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                ...
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/transportfees/deleteTransportfees/<?php echo $val['transportfeesId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                    </a>
