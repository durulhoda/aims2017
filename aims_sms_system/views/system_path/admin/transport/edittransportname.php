...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/transport/updatetransportName/<?php echo $editData['transportId']; ?>" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data[transportName]" value="<?php echo $editData['transportName']; ?>"  id="form-field-1" placeholder="Enter Category" class="col-xs-8 col-sm-3" />
