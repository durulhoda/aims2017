...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/transportroot/updateTransportRoot/<?php echo $editData['rootId'];?>" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data[transportRoot]" value="<?php echo $editData['transportRoot']; ?>" id="form-field-1" placeholder="Enter Root" class="col-xs-8 col-sm-3" />
