...
<div class="row">
    ...
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form  action="<?php echo admin_Url(); ?>/setsummarypercentage/update_percentage" method="post" class="form-horizontal" role="form">
            ...
            foreach($exam_list as $item)
            {
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="semester[<?php echo $item['semester_id'];?>]" value="<?php echo $percentage[$item['semester_id']];?>" required="" placeholder="Enter Percentage" class="integer_type_positive col-xs-8 col-sm-3" />
                </div>
            <?php
            }
            ?>
