...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/hostelbed/inserthostelbed" method="post" class="form-horizontal" role="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs btn-group">
                                         ...
                                         <a href="<?php echo admin_Url();?>/hostelbed/edithostelBed/<?php echo $val['bedId']; ?>" class="btn btn-xs btn-info">
                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                        </a>

                                        <a href="<?php echo admin_Url();?>/hostelbed/deletehostelBed/<?php echo $val['bedId']; ?>" class="btn btn-xs btn-danger">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/hostelbed/edithostelBed/<?php echo $val['bedId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                ...
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/hostelbed/deletehostelBed/<?php echo $val['bedId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                    </a>
