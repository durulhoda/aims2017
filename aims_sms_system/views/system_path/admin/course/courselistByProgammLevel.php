...
<div class="page-header">
    <h1>
        ...
        <small class="red">
            ...
            Search Subject Information By Program Level
        </small>
    </h1>
</div><!-- /.page-header -->
...
<div class="row">
    ...
    ?>    
    <div class="col-xs-12">
        <form class="form-horizontal" role="form" action="<?php echo admin_Url(); ?>/course/searchSubjectList" method="post">
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-12">
                        <button  class="btn btn-success" name="btnSubmit" type="submit">
                            <i class="ace-icon fa fa-check bigger-110"></i> Search Subject List
                        </button>
                ...
                <div class="col-xs-12">
                    <table id="simple-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sl = 1;
                            foreach ($courselistby_PL as $val) {
                                ?>
                                <tr>
                                    <td> <?php echo $sl++; ?></td>
