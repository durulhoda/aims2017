...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/hostelroom/updatehostelRoom/<?php echo $editData['roomId'];?>" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data[hostelRoom]" value="<?php echo $editData['hostelRoom']; ?>"></td>
