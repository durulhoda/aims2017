    ...
    <div class="page-header">
        <h1>
            ...
            <small class="red">
               ...
               Edit Hostel Bed Rent Information
            </small>
        </h1>
    </div><!-- /.page-header -->
...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/hostelrent/updatehostelRent/<?php echo $editData['rentId']?>" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="data[rent]" value="<?php echo $editData['rent']; ?>"></td>
