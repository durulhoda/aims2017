<!-- /Content Section  -->                    
    ...
    <div class="row">
        <?php
            ...
            ?>              
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="<?php echo admin_Url() ?>/homework/homeworkinfo" method="post">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div>
                                    ...
                                    <textarea style="height:200px" class="form-control" name="data[homework]" id="form-field-8" placeholder="Write Homework Details "></textarea>
                                </div>
