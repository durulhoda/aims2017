        ...
        <div class="row">
            <div class="col-xs-12">
                    <div class="widget-box">
                        ...
                        <form class="form-horizontal" role="form" action="<?php echo admin_Url() ?>/homework/updatehomework/<?php echo $editData['hwId'];?>" method="post">
                        <div class="widget-body">
                           ...
                           <textarea name="updatehomework" style="width:600px; height:150px"><?php echo $editData["homework"]; ?></textarea>
