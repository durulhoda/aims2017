        ...
        <div class="widget-header widget-header-large">
            <div class="center">
                ...
                <div class="time">
                    ...
                    <h4> Student Position List For Summery Result </h4>
                </div>
            </div>
            <br>
            <center>
                <div id="id-message-infobar" style="background: #e5e5e5 none repeat scroll 0 0; margin-left: -18px; padding: 3px;">
                    ...
                    <span class="blue bigger-130"><?php if(!empty($programOfferId['programId'])){ echo "Session : ".getSessionName($programOfferId['sessionId'])." - Class : ".getProgramName($programOfferId['programId'])." - Shift : ".getShiftName($programOfferId['shiftId'])." - Group : ".getGroupName($programOfferId['groupId']); } ?></span>
                </div>
            </center>
        </div>
