...
<div class="row">
    ...
    ?>
    <div class="col-xs-12">
        <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/generatesummaryresult/generate_summary_resultsd" method="post">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="clearfix form-actions">
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo site_url('systemaccess/generatesummaryresult'); ?>" class="btn btn-info"><i class="ace-icon fa fa-search bigger-120"></i>Refresh</a>
                    </div>
                </div>
            </div>
        </form>
