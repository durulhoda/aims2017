...
<table class="detailsTable" style=" font-family: cambria; margin: 10px 10px; width: 97%; border-collapse: collapse;" id="tblprint">
    ...
    <tbody>
        ...
        <tr style="border: 1px solid #D8D8D8; ">
            <td style="text-align: center" class="center_border">1</td>
            <td style="text-align: left" rowspan="" class="center_border">
                
            </td>
            <td style="text-align: left" rowspan="1" class="center_border"></td>
            <td class="center_border"></td>
            <td class="center_border"></td>
            <td style="text-align: left" class="center_border"></td>
            <td class="center_border <?php echo $color; ?>"></td>
            <td rowspan="" class="center_border"><?php echo $val['gpa_letter'];?></td>
            </tr>
    </tbody>
</table>
