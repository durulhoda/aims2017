            ...
            <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/studentmarks/searchstudentlist" method="post">
                <div class="col-xs-12 col-sm-12">  
                    ...
                    <div class="col-xs-10 col-sm-4">
                        ...
                        <select name="data[semesterId]" onchange="return get_subjects_name();" required="1" class="form-control getsemesterid" id="form-field-select-1">
                            <option value="">Select</option>
                    ...
                    <div class="col-xs-10 col-sm-4">
                        ...
                        <select id="getSubjectid"  data-placeholder="Select" name="data[courseId]"  class="form-control">
                               ...
                               <!--<div class="col-xs-10 col-sm-4">
                                    <label class="control-label" for="form-field-1">Exam Type &nbsp; <?php// echo form_error('examtypeId', '<span class="successMessage">', '</span>'); ?></label>
                                    <select name="data[examtypeId]" required="1" class="form-control" id="form-field-select-1">
                                        <option value=""> Select </option>
                                            <?php// foreach (getExamList() as $velues) { ?>
                                                <option value="<?php// echo $velues['examtypeId']; ?>" <?php// echo set_select('examtypeId', $velues['examtypeId'], FALSE) ?>><?php// echo $velues['examtypeName'] ?></option>
                                            <?php// } ?>
