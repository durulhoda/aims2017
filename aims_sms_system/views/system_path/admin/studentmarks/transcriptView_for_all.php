...
<div style="margin: 10px auto;width: 850px;border: 3px solid #cccccc;border:3px solid #d9d9d9;page-break-before: always">
<table style="width:100%; border-bottom: 2px solid #ddd; margin-bottom: 3px">
    ...
    <tr>
        <td style="text-align: center; ">
            ...
            <h3 style="font-family: century gothic; color:green;"><?php echo getSemesterName($semesterId)."' ".$program_info->session_name; ?></h3>
        </td>
    </tr>
    </tbody>
</table>
<div style="margin-top: 10px;float:left; border:0px solid red; width:160px; margin-left: 9px;">
    <img src="<?php echo ($student_info[$key]->photo) ? base_url().$student_info[$key]->photo :  base_url().'/uploads/default/default.png' ?>" width="152" height="auto" align="middle">
</div>
<div style="margin: 10px 10px 20px; font-family: cambria; height: 170px; width:98%; border:0px solid red;">
    <table style="margin-left:5px;width:50%; float: left;border:0px solid red; line-height: 20px;">
        <tbody>
        <tr>
            ...
            <td style="text-align: left; "> 
							<span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">
							        : <?php echo ($student_info[$key]->studentId) ? $student_info[$key]->studentId : ""; ?>
							</span>
            </td>
        </tr>
        <tr style="line-height: 20px;">
            ...
            <td>
							<span class="color_blue" style="font-size: 21px; font-family: Segoe UI Semibold;">
								    : <?php echo ($student_info[$key]->firstName) ? $student_info[$key]->firstName : ""; ?>
                            </span>
            </td>
        </tr>
        <tr>
            <td style="text-align: left; ">
                <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">Roll No. </span>
            </td>
            <td>
                            <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">
                                    : <?php echo $roll_no[$key]['roll_no']; ?>
                            </span>
            </td>
        </tr>
        <tr>
            <td style="text-align: left; ">
                ...
                <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">Class </span>
            </td>
            <td>
							<span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">
        ...
        <tr>
            <td style="text-align: left; "><span style="text-align: left; ">
                <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;"> Shift </span>
            </td>
            <td>
							<span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">
        ...
        <tr>
            <td style="text-align: left; ">
                <span style="text-align: left; ">
                <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;"> Group </span>
            </td>
            <td>
                            <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">
        ...
        <tr>
            <td style="text-align: left; ">
                <span style="text-align: left; ">
                <span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">Section </span>
            </td>
            <td>
							<span class="color_green" style="font-size: 20px; font-family: Segoe UI Semibold;">
...
<table class="detailsTable" style=" font-family: cambria; margin: 10px 10px; width: 97%; border-collapse: collapse;" id="tblprint">
    ...
    $m_count = [];
    $i = 1;
    foreach ($records[$key]['record'] as $index => $val) :
...
<div style="">
    <table class="table table-bordered" style=" font-family: cambria; margin: 10px 10px; width: 60%; border-collapse: collapse;float: left;" id="">
        ...
        <tr>
            ...
            <td><b><?php echo $records[$key]['total']['total_marks_common_full']; ?></b></td>
            <td><b><?php echo $records[$key]['total']['total_marks_common_final']; ?></b></td>
        </tr>
        <tr>
            <td>Grand Total Marks (Com+Add+Con)</td>
            <td><b><?php echo $records[$key]['total']['grand_total_marks_full']; ?></b></td>
            <td><b><?php echo $records[$key]['total']['grand_total_marks']; ?></b></td>
        </tr>
        </tbody>
    </table>
    <table class="table table-bordered" style="margin-right:16px; font-family: cambria; width: 25%; border-collapse: collapse;float:right;" id="">
        ...
        <trstyle="background-color: lightgrey !important;">
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b>GPA</b></td>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b><?php echo $records[$key]['total']['gpa_point']; ?></b></td>
        </tr>
        <tr>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b>Letter Grade</b></td>
            <td  style="text-align: left; ">
                <span class="color_green" style="font-size: 18px; font-family: Segoe UI Semibold;"><b><?php echo $records[$key]['total']['gpa_letter']; ?></b></td>
        </tr>
        <tr>
            <td style="text-align: left; ">
                <span class="color_green" style="font-size: 16px; font-family: Segoe UI Semibold;">Percentage Marks</td>
            <td style="text-align: left; ">
                <span class="color_green" style="font-size: 16px; font-family: Segoe UI Semibold;"><?php echo round(($records[$key]['total']['total_marks_common_final'] * 100)/$records[$key]['total']['total_marks_common_full'])."%"; ?></td>
        </tr>
        <tr>
            <td style="text-align: left; ">
                <span class="color_green" style="font-size: 16px; font-family: Segoe UI Semibold;">Failed Subject</td>
            <td style="text-align: left; ">
                <span class="color_red" style="font-size: 16px; font-family: Segoe UI Semibold;"><?php echo $records[$key]['total']['tot_fail_subj']; ?></td>
        </tr>
        </tbody>
    </table>
</div>
...
<table style=" font-family: cambria;margin: 10px 10px; border-collapse: collapse;">
    <tr>
        <td colspan="6" style="padding:10px 10px 5px;text-align: right; font-size: 14px; font-weight: bold;"><span class="color_green" style="font-size: 16px; font-family: Segoe UI Semibold;">Student Position</span> :<class="color_red" style="font-size: 16px; font-family: Segoe UI Semibold;"> <?php echo $records[$key]['total']['position']; ?></td>
...
<table style=" font-family: cambria; margin: 10px 10px; width: 97%; border-collapse: collapse;">
    <?php if ($records[$key]['total']) : ?>
        <tbody>
        <tr>
            <td colspan="12" style="padding:10px 0px 5px;text-align: left; font-size: 15px; font-weight: bold;">
                <!--  					<hr>-->
                &nbsp;&nbsp;Remarks : <?php echo $records[$key]['total']['result_comment']; ?>
            </td>
        </tr>
        <tr>
