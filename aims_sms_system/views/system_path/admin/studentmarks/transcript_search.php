...
<div class="row">
    ...
    ?>
    <div class="col-xs-12">
        <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/studentmarks/class_transcripts" method="post">
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="col-xs-10 col-sm-4">
                    ...
                    <select id="getsessionid"  data-placeholder="Select" name="data[semesterId]" required=""  class="form-control">
                        <option value="">Select</option>
