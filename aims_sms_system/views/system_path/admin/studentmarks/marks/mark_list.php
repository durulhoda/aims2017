    ...
    <?php endif; ?>
        <?php if (isset($student_list) && $student_list) : ?>
            <div class="col-xs-12 col-sm-12">
                <div class="col-xs-12 col-sm-12">
                    <div class="widget-box transparent">
                        <div class="widget-header widget-header-large">
                            ...
                            <div class="widget-toolbar hidden-480">
                                ...
                                <a href="#" onclick="printDiv('printableArea')" role="button" class="green" > Print Entry Form</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="hidden-sm hidden-xs btn-group">
                                <a href="<?php echo site_url()."systemaccess/studentmarks/mark_add/".$val->markId; ?>" class="btn btn-xs btn-info">
                                <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                            </div>
                        <?php else : ?>
                            <div class="hidden-sm hidden-xs btn-group">
                                <a href="<?php echo site_url()."systemaccess/studentmarks/mark_add/0?courseId=$courseId&semesterId=$semesterId&programOfferId=$poid&studentId=$val->studentId&employeeId=$employeeId"; ?>" class="btn btn-xs btn-success">
