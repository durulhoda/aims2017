            ...
            <div class="col-xs-12">
                <ul class="list-unstyled" style="text-align: center;">
                    <li>
                        ...
                        ?>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <i class="ace-icon fa fa-caret-right blue"></i>Exam Name:
                        <?php
...
<form id="frm1" action="<?php echo admin_Url() ?>/studentmarks/update_inserted_marks" method="post">
    <div class="col-xs-12 col-sm-12">
        <!-- PAGE CONTENT BEGINS -->
    ...
    <div>
                ...
                if (in_array($courseId, explode(',', trim($value['courseId'])))) {
                    ...
                    <tr class="main_child">
                        ...
                        if (!empty($dividemark)) {
                            ...
                            $subject_marks = explode(",", trim($students_marks[$value['studentId']]['divide_mark'], ","));
                            ...
                            for ($mrk = 0; $mrk < $count_markval; $mrk++) {
                                ...
                                <td >
                                    <input type="number"  name="other_marks[<?php echo $value['studentId'];?>][]" min="0" max="<?php echo $mark_val[$mrk]; ?>" value="<?php echo $subject_marks[$mrk];?>" class="calField su" id="su<?php echo $mrk; ?>"
                                </td>
        ...
        <div id="printButton1" class="form-group col-xs-12 col-sm-4">
            ...
            <div  id="form-field-select-1" >
                <button class="btn btn-success" onclick="return checkConfirm('Student Marks, Semester & Exam Information ?');" name="btnSubmit" type="submit">
                    <i class="ace-icon fa fa-check bigger-110"></i> Update Marks
                </button>
            </div>
        </div>
    </div>
