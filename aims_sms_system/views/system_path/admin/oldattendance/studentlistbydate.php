             ...
             <form id="frm1" action="<?php echo admin_Url() ?>/studentsattendance/insertattendance" method="post">
                ...
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    <thead>
                        ...
                        <tr>
                            <th class="hidden-480">
                            <input type="checkbox" name="serial[]" value="<?php echo $sl++; ?>" onclick="checkedAll()"/>
                            </th>
        ...
        <div class="col-xs-10 col-sm-12">
                      <div class="col-sm-4">
                          <div class="input-group input-group-sm">
                              <input class="form-control date-picker" placeholder="Select Date" id="id-date-picker-1" name="attendanceDate" type="text" data-date-format="dd-mm-yyyy" />
