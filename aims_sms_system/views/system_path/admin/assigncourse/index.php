    ...
    <div class="page-header">
        <h1>
            ...
            <small class="red">
               ...
               Student Subject Assign Information
            </small>
        </h1>
    </div><!-- /.page-header -->
            ...
            <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/assigncourse/searchcourseassignlist" enctype="multipart/form-data" method="post">
                   ...
                   <div class="col-xs-12 col-sm-12">  
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <div class=" col-xs-10 col-sm-4">
                            <label class="control-label" for="form-field-1">Group  &nbsp; <?php echo form_error('data[groupIdd]', '<span class="successMessage">', '</span>'); ?></label>
