                                    ...
                                    <div class="col-xs-12">
                                        <div class="clearfix form-actions">
                                            <div class="col-md-12">
                                                <button class="btn btn-success" name="search" type="submit">
                                                    <i class="ace-icon fa fa-search bigger-120"></i>
                                                    Search Student Attendance by Institute
                                                </button>
                        ...
                        <div style=" border: 1px solid #d9d9d9;">
                            <div>
                                <table style="width:100%; border-bottom: 2px solid #ddd; margin-bottom: 3px">
                                    ...
                                    <tr> <td style="text-align: center; "> <h3 style="font-family: Algerian;">Search By Attendance Status</h3> </td> </tr>
                                ...
                                <div>
                                    ...
                                    <table id="simple-table" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="hidden-480">
                                                    <input type="checkbox" name="checkall" id="ckbCheckAll"/>
                                                </th>
                                                <th class="center">
                                                    Sl No.
                                                </th>
                                        ...
                                        <tbody>
                                            <?php
                                            $sl = 1;
                                            foreach ($attendanceStatus as $value) {
                                                ?>

                                                <tr>
                                                    <td><input type="checkbox" class="checkBoxClass" name="studentId[]" value="<?php echo $value['studentId']; ?>"></td>
                                                    <td class="center" >
                                                        <?php echo $sl++; ?>
                                                    </td>
