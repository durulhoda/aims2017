    ...
    <div class="page-header">
        <h1>
            ...
            <small class="red">
                ...
                Edit Inventory Stock Information
            </small>
        </h1>
    </div><!-- /.page-header -->
...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/inventorystock/updateinventorystock/<?php echo $editData['stockId'];?>" method="post" class="form-horizontal" role="form">
    ...
    <div class="form-group">
                    ...
                    <input type="text" name="data[itemStock]" value="<?php echo $editData['itemStock']; ?>"  id="form-field-1" placeholder="Enter Stock Item " class="col-xs-9 col-sm-3" />
