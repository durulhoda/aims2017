...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/inventorystock/insertinventorystock" method="post" class="form-horizontal" role="form">
    ...
    <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Stock Item : &nbsp; </label>


                    <input type="text" name="data[itemStock]"  id="form-field-1" placeholder="Enter Stock Item " class="col-xs-9 col-sm-3" />
                ...
                <div class="col-xs-12">
                    <table id="simple-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                                $sl=1;
                                foreach($inventorystocklist as $val)
                                {
                            ?>
                            <tr>
                                <td> <?php echo $sl++; ?></td>
                                ...
                                <td> <?php if (!empty($val['itemPiece'])) { echo $val['itemPiece'];} ?></td>
                                 <td> <?php if (!empty($val['itemUse'])) { echo $val['itemUse'];} ?></td>
                                  <td> <?php if (!empty($val['itemStock'])) { echo $val['itemStock'];} ?></td>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs btn-group">
                                         ...
                                         <a href="<?php echo admin_Url();?>/inventorystock/editinventorystock/<?php echo $val['stockId']; ?>" class="btn btn-xs btn-info">
                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                        </a>

                                        <a href="<?php echo admin_Url();?>/inventorystock/deleteinventorystock/<?php echo $val['stockId']; ?>" class="btn btn-xs btn-danger">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/inventorystock/editinventorystock/<?php echo $val['stockId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                ...
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/inventorystock/deleteinventorystock/<?php echo $val['stockId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                    </a>
