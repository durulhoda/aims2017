...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/inventory/insertinventory" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="data[price]"  id="form-field-1" placeholder="Enter Item Price" class="col-xs-9 col-sm-3" />
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" name="data[boughtBy]"  id="form-field-1" placeholder="Enter Item Purchaser Id " class="col-xs-9 col-sm-3" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs btn-group">
                                         ...
                                         <a href="<?php echo admin_Url();?>/inventory/editinventory/<?php echo $val['inventoryId']; ?>" class="btn btn-xs btn-info">
                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                        </a>

                                        <a href="<?php echo admin_Url();?>/inventory/deleteinventory/<?php echo $val['inventoryId']; ?>" class="btn btn-xs btn-danger">
                                    ...
                                    <div class="hidden-md hidden-lg">
                                        <div class="inline pos-rel">
                                            ...
                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/inventory/editinventory/<?php echo $val['inventoryId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                        <span class="green">
                                                ...
                                                <li>
                                                    <a href="<?php echo admin_Url();?>/inventory/deleteinventory/<?php echo $val['inventoryId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                        <span class="red">
                                                            <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                        </span>
                                                    </a>
