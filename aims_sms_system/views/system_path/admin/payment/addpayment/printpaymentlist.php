...
<div class="row">
    ...
    <div style="width: 70px; margin-left: 162px;">
        <img src="<?php echo base_Url() . $ins_info['logo'] ?>" alt="Institute Logo" width="70" height="70" align="middle"> 
                    ...
                    <h5 style="font-size: 18px; text-align: center;">    <?php   $ins_name=getInstituteInfo(); 
    ...
    <table>
        <tr>
          ...
          <tr>
            ...
            <td>&nbsp;</td><td>&nbsp;</td>
            <td>&nbsp;</td><td>&nbsp;</td>
            <td style="color:green">Session&nbsp;</td>
            <td>:</td>
...
<br>
     ...
     <table id="simple-table" class="table table-bordered">
                            ...
                            <tbody>
                            <?php if($feeslist) : ?>
                            <?php $total_sum = 0; foreach($feeslist as $key => $val) : 
...
<span class="text-success">Word In (BDT): <?php echo convert_number_to_words($total_sum); ?> only.</span>
