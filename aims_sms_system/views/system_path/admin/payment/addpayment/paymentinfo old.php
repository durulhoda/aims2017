...
<div class="row">
    <form action="<?php echo admin_Url(); ?>/paymentadd/insertpaymentadd" method="post">
        <div class="col-sm-5">
                                            ...
                                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($feeslist as $value) {
                                                        ...
                                                        $discount = getStudentDiscountList($studentId, $value['headId'], $programOfferId); // Get Student Discount by Payment Head ID 
                                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                if (!getStudentpaymentList($studentId, $value['headId'], $info['sessionId'], 1)) {
                                                                   ...
                                                                   <input type="checkbox" name="discount_id[]" value="<?php echo ($discount['discountId']) ? $discount['discountId'] : 0 ?>">
                                                                    <?php
                                                                } else {
                                                                    echo "Paid";
                                                                }
                                                            ...
                                                            <td>
                                                                <!-- <input type="hidden" name="discount_id[]" value="<?php echo ($discount['discountId']) ? $discount['discountId'] : 0 ?>"> -->
                                                                <?php
                                                                if (!empty($discount)) {
        ...
        if (!getStudentpaymentList($studentId, $value['finehead'], $sessionId , 2)) {
            ?>
                                                                    ...
                                                                    <input type="checkbox" name="payment_status[]"  value="2">
                                                                    <input type="checkbox" name="discount_id[]" value="0">
