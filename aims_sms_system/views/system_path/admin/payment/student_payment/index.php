...
<div class="row">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/student_payment/searchpaymentinfo" method="post" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="form-field-1" name="data[studentId]" placeholder="Student ID" class="col-xs-10 col-sm-2" required="" />
            </div>
            <!--    
             <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Student Status : </label>

                        <select required name="studentStatus" class="col-xs-10 col-sm-2">
