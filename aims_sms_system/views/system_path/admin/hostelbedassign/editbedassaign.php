    ...
    <div class="page-header">
        <h1>
            ...
            <small class="red">
              ...
              Edit Hostel Bed Assign Information
            </small>
        </h1>
    </div><!-- /.page-header -->
...
<div class="row">
    ...
    <!-- div.table-responsive -->
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form  action="<?php echo admin_Url(); ?>/hostelbedassign/updatehostelBedAssign/<?php echo $editData['bedassignId'];?>" method="post" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <select name="data[bedNo]" class="col-xs-9 col-sm-3" class="form-control">
                           <option value="">Select</option>
                                        <?php foreach (getHostelBedList() as $values) { ?>
                                            <option value="<?php echo $values['bedNo']; ?>" 
                                                   <?php echo ($editData["bedNo"] == $values['bedNo']) ? "selected" : "" ?> >
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="data[studentId]" value="<?php echo $editData['studentId']; ?>">
