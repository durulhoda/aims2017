                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <blockquote class="pull-left">
                                ...
                                <?php } ?>   
                                <?php if(!empty($studentlist['religion'])){ ?>
                                    <small>    
                                        Religion:
                                        <cite title="Student Birth Date" class="lighter red"> <?php echo element($studentlist['religion'],  getReligion(),Null); ?> </cite>                                    
                                    </small>
                                <?php } ?>
                        ...
                        <div class="widget-body">
                            <div class="widget-main row ">
                                ...
                                ?>    
                                    ...
                                    <span class="col-sm-5 prettyprint linenums"><strong> <input type="text" name="roll_no" placeholder="Roll No..." value=""></strong>
