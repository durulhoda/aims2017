                            ...
                            <td>                                
                                <?php 
                                    if (!empty($value['fatherName'])) {
                                        echo "<b>" . $value['fatherName'] . "</b><br>".$value['fatherPhone'] ; 
                                    }
                                ?>
                            </td>
                            <td>                                
                                <?php 
                                    if (!empty($value['motherName'])) {
                                        echo "<b>" . $value['motherName'] . "</b><br>".$value['motherPhone'] ; 
                                    }
                                ?>
                            </td>
                            <td>
                                    ...
                                    <a class="red" id="dlele" onclick="return checkDelete('Applicant ?');" href="<?php echo admin_Url();?>/applicant/DeleteApplicant/<?php echo $value['applicationId']?>" title="Delete">
                                     ...
                                     <?php
                                           $registrationStatus = getStudentByApplicationId($value['applicationId']);
                                            if (empty($registrationStatus)) {                                               
                                    ?>                                    
                                    <a target="_blank" class="pink" href="<?php echo admin_Url(); ?>/applicant/apply_registration/<?php echo $value['applicationId']; ?>" title="Registration">
                                ...
                                <div class="hidden-md hidden-lg">
                                    <div class="inline pos-rel">
                                        <button class="btn btn-minier btn-yellow dropdown-toggle" data-toggle="dropdown" data-position="auto">
                                            ...
                                            <li>
                                                 <?php
                                                        $registrationStatus = getStudentByApplicationId($value['applicationId']);
                                                         if (empty($registrationStatus)) {                                               
                                                 ?> 
                                                <a target="_blank" href="<?php echo admin_Url(); ?>/applicant/Edit_RegistrationForm/<?php echo $value['applicationId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                    <span class="green">
                                            ...
                                            <li>
                                                <a style="pointer-events: none; cursor: default;" href="<?php echo admin_Url();?>/applicant/DeleteApplicant/<?php echo $value['applicationId']?>" onclick="return checkDelete('Applicant ?');" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                    <span class="red">
                                      ...
                                      <!--      <?php
                                             ...
                                             ?>
                                            <li>
                                                <a target="_blank" href="<?php echo admin_Url(); ?>/applicant/apply_registration/<?php echo $value['applicationId']; ?>" class="tooltip-error" data-rel="tooltip" title="Registration">
                                                    <span class="red">
                                             ...
                                             <?php
                                                        ...
                                                        echo "<span class=\"label label-sm label-success\">Registered</span>";
                                                        }
                                                    ?>
                                            -->
                                        </ul>
