<!-- /Content Section  -->                    
    ...
    <div class="row">
        <?php
            ...
            ?>              
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="<?php echo admin_Url() ?>/syllabus/insertsyllabus" method="post">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                     <div class=" col-xs-10 col-sm-4">
                      ...
                      <div class="col-xs-10 col-sm-4">
                            ...
                            <select id="getsectionid" name="datax[sectionId]" class="form-control">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div>
                                    ...
                                    <textarea style="height:200px" class="form-control" name="data[syllabus]" id="form-field-8" placeholder="Write Syllabus Details"></textarea>
                                </div>
