            ...
            <form class="form-horizontal" role="form" action="<?php echo admin_Url();?>/courseoffer/insertCourseoffer" method="post">
                <div class="col-xs-12 col-sm-12">  
                    ...
                    <div class="col-xs-10 col-sm-4">
                        ...
                        <select id="getcourseid" name="data[courseId]" required="1" class="form-control" id="form-field-select-1">
                            
                        </select>
                    </div>
                    
                    <div class="col-xs-10 col-sm-4">
                        <label class="control-label" for="form-field-1">Subject Category &nbsp; <?php echo form_error('data[categoryName]', '<span class="successMessage">', '</span>'); ?></label>
                        <select name="data[categoryName]" required="1" class="form-control" id="form-field-select-1">
                            <option value=""></option> 
                            <?php
                                foreach (getSubjectcategory() as $key => $value) {
                            ?>
                                <option value="<?php echo $key; ?>" 
                                        <?php echo set_select("data[categoryName]", $key, FALSE); ?> >
                                        <?php echo $value; ?>
                                </option> 
                    ...
                    <div class="col-xs-10 col-sm-4">
                        ...
                        <input type="text" name="data[marks]" required="1" value="<?php echo set_value("data[marks]"); ?>" class="form-control" id="form-field-1" placeholder="Subject Marks" />
                    </div>
