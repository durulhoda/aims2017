...
<!-- /Content Section  -->                    
    ...
    <div class="row">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="modal-body no-padding">
                                        ...
                                        <form class="form-horizontal" role="form" action="<?php echo teacher_Url(); ?>/studentcomment/searchindividualStudent" method="post">
        ...
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="<?php echo teacher_Url();?>/studentcomment/searchRegisteredStudent" enctype="multipart/form-data" method="post">
