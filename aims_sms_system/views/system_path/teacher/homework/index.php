...
<!-- /Content Section  -->                    
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo teacher_Url() ?>/homework/inserthomework" method="post">
                ...
                <div class="col-xs-12 ">
                    <div class="widget-box">
                        <div class="widget-header">
                            <h4 class="widget-title">Homework Details :</h4>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div>
                                    ...
                                    <textarea style="height:300px" class="form-control" name="data[homework]" id="form-field-8" placeholder="Write Homework Details "></textarea>
                                </div>
