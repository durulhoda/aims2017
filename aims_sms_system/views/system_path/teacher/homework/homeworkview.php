...
<!-- /Content Section  -->                    
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo teacher_Url() ?>/homework/searchhomeworklist" method="post">
               <div class="row"> 
                <div class="col-xs-12 col-sm-12">  
                   ...
                   Teacher :
                        ...
                        $as = getTeacher($username);
                        echo $as['firstName'] . " " . $as['lastName'];
                        ?>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="<?php echo teacher_Url() . "/homework/viewhomework/" . $value['hwId']; ?>">VIEW More</a>
                                        </td>
                                        
                                               <td>
                                            <div class="hidden-sm hidden-xs btn-group">

                                                <a href="<?php echo teacher_Url();?>/homework/edithomework/<?php echo $value['hwId']; ?>" class="btn btn-xs btn-info">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>

                                                <a href="<?php echo teacher_Url();?>/homework/deletehomework/<?php echo $value['hwId']; ?>" class="btn btn-xs btn-danger">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                <div class="inline pos-rel">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                        <li>
                                                            <a href="<?php echo teacher_Url();?>/homework/edithomework/<?php echo $value['hwId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                <span class="green">
                                                        ...
                                                        <li>
                                                            <a href="<?php echo teacher_Url();?>/homework/deletehomework/<?php echo $value['hwId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                <span class="red">
                                                                    <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                </span>
                                                            </a>
