                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main row ">
                                ...
                                <form class="form-horizontal distribute_table" role="form" action="<?php echo teacher_Url(); ?>/Subjectmarks/insertdvdmark" enctype="multipart/form-data" method="post" autocomplete="off">
