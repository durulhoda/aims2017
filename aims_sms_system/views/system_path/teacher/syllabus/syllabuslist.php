                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form" action="<?php echo teacher_Url();?>/syllabus/searchsyllabuslist" method="post">
                               <div class="row"> 
                    ...
                    <div class=" col-xs-10 col-sm-4">
                        ...
                        <select id="getprogramid" onchange="return getOfferedprogramId_Subjectid_byEMP(); " name="data[programId]" required="1" class="form-control">
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="<?php echo teacher_Url() . "/syllabus/viewsyllabus/" . $value['syllabusId']; ?>">VIEW More</a>
                                        </td>
                                        
                                               <td>
                                            <div class="hidden-sm hidden-xs btn-group">

                                                <a href="<?php echo teacher_Url();?>/syllabus/editsyllebus/<?php echo $value['syllabusId']; ?>" class="btn btn-xs btn-info">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>

                                                <a href="<?php echo teacher_Url();?>/syllabus/deletesyllabus/<?php echo $value['syllabusId']; ?>" class="btn btn-xs btn-danger">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                <div class="inline pos-rel">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                        <li>
                                                            <a href="<?php echo teacher_Url();?>/syllabus/editsyllebus/<?php echo $value['syllabusId']; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                                                <span class="green">
                                                        ...
                                                        <li>
                                                            <a href="<?php echo teacher_Url();?>/syllabus/deletesyllabus/<?php echo $value['syllabusId']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                <span class="red">
                                                                    <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                                </span>
                                                            </a>
