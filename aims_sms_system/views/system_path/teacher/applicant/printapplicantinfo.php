        ...
        <div class="col-xs-8 col-sm-offset-1" id="printableArea">
            ...
            <div id="user-profile-1" class="user-profile">
                    ...
                    <div class="profile-user-info profile-user-info-striped">
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                <span id="username"><?php echo $editData["firstName"] ; ?></span>
                            </div>
                        </div>
                        ...
                        <div class="profile-info-row">
                            ...
                            <div class="profile-info-value">
                                ...
                                <span id="country"><?php echo $editData["applicationId"]; ?></span>
                ...
                <div class="clearfix">
                    ...
                    <div class="grid5">
                        <span class="bigger-150 green">Class</span>
                    ...
                    <div class="grid5">
                        <span class="bigger-150 green">Medium</span>

                        <br />
                        <?php if(!empty($enrollData['mediumId'])){ echo getmediumName($enrollData['mediumId']);}?>
                    </div>
                    <div class="grid5">
                        <span class="bigger-150 green">Group</span>
                    ...
                    <div class="grid5">
                        <span class="bigger-150 green">Shift</span>

                        <br />
                        <?php if(!empty($enrollData['shiftId'])) {echo getshiftName($enrollData['shiftId']);}?>
                    </div>
                    <div class="grid5">
                        <span class="bigger-150 green">Session</span>
