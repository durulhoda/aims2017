...
<!-- /.row --> 
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="widget-box transparent ">
                    <div class="widget-header widget-header-large">
                        <div class="widget-toolbar pull-left">
                            ...
                            <a href="#modal-table_student" role="button" class="purple" data-toggle="modal">  Individual Student </a>

                        </div>
                        <div class="widget-toolbar pull-left">
                            <i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer red"></i>
                            <a href="#modal-table" role="button" class="red" data-toggle="modal"> Class Information </a>
                                        ...
                                        <li>
                                            <i class="ace-icon fa fa-caret-right blue"></i>Class Level: 
                                                ...
                                                foreach (getProgramLevel() as $key =>$value) {
                                                    if ($programOfferId['programLevel'] == $key) {
                                                        echo "<b>" . $value . "</b>";
                                                    }
                                                }
                                                ?>
            ...
            <form id="frm1" action="<?php echo teacher_Url(); ?>/studentmarks/savemarks" method="post">
                <div>
