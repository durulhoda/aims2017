...
class TCPDF_STATIC {
	 ...
	 * <li>A7 (74x105 mm ; 2.91x4.13 in)</li>
         * <li>Aid (74x105 mm ; 2.91x4.13 in)</li>
	...
	public static function getPageSizeFromFormat($format) {
		...
		switch (strtoupper($format)) {
			...
			case 'A7' : {$pf = array(  153.200,  245.00); break;}
                        case 'Aid' : {$pf = array(  153.200,  245.00); break;}
			...
			case 'PA7' : {$pf = array(  153.200,  245.00); break;}
                        case 'PAid' : {$pf = array( 153.200,  245.00); break;}
