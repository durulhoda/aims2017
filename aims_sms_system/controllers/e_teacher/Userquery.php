...
class Userquery extends CI_controller { 
    ...
    public function getOfferedprogramId_Subjectid_byEMP(){
        $classid = (int)$this->input->post('id', TRUE);          
        $employee=$this->session->userdata('emp_userName');
        $datalist = $this->CourseofferModleAdmin->getOfferedprogramId_Subjectid_byEMP($classid,$employee);
