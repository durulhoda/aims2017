...
class InventoryStock extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('templates/accounts/inventorystock/index');
...
//                    redirect(base_url('admin/campus'));
       redirect(acc_Url() . "/inventorystock/inventorystocklist");
        } else {
    ...
    public function inventorystocklist() {
        ...
        $this->load->view('system_path/accounts/inventory/inventorystock/index', $data); // ...........body content page...........
    ...
    public function editinventorystock($id) {
        ...
        $this->load->view('system_path/accounts/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/accounts/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/accounts/inventory/inventorystock/editinventorystock', $data); // ...........body content page...........
        $this->load->view('system_path/accounts/common/footer'); // footer & script link
    }
