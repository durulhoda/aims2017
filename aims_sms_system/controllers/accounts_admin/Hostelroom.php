...
class HostelRoom extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('system_path/accounts/hostelroom/index', $data); // ...........body content page...........
    ...
    public function inserthostelroom() {
        ...
        if ($this->form_validation->run() == FALSE) {
            redirect(acc_Url() . "/hostelroom/index");
        } else {
    ...
    public function hostelRoomlist() {
        ...
        $this->load->view('templates/accounts/hostelroom/viewhostelroomlist', $data);
    ...
    public function edithostelRoom($id) {
        ...
        $this->load->view('system_path/accounts/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/accounts/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/accounts/hostelroom/edithostelroom', $data); // ...........body content page...........
        $this->load->view('system_path/accounts/common/footer'); // footer & script link
