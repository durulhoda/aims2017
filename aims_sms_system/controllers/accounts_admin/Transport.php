...
class Transport extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('system_path/accounts/transport/index', $data); // ...........body content page...........
    ...
    public function transportcategory() {
        ...
        $this->load->view('templates/accounts/transport/transportcategory');
    ...
    public function insertcategory() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(acc_Url()."/transport/index");
    ...
    public function transportcategorylist() {
        ...
        $this->load->view('templates/accounts/common/header');
        $this->load->view('templates/accounts/transport/viewtransportcategorylist', $data);
        $this->load->view('templates/accounts/common/footer');
    }
    ...
    public function inserttransportName() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(acc_Url(). "/transport/transportNamelist");
    ...
    public function transportNamelist() {
        ...
        $this->load->view('system_path/accounts/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/accounts/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/accounts/transport/transportname', $data); // ...........body content page...........
        $this->load->view('system_path/accounts/common/footer'); // footer & script link
    ...
    public function editTransportName($id) {
        ...
        $this->load->view('system_path/accounts/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/accounts/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/accounts/transport/edittransportname', $data); // ...........body content page...........
        $this->load->view('system_path/accounts/common/footer'); // footer & script link
    }
...
//        print_r($data);
        $this->load->view('templates/accounts/transport/edittransportcategory', $data);
        $this->load->view('templates/accounts/common/footer');
    }
