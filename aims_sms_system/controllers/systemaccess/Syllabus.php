...
class Syllabus extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('system_path/admin/syllabus/index'); // ...........body content page...........
...
//        print_r($yes_upload);exit;
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($data['programOfferId'])) {
                $data['programOfferId'] = $data['programOfferId']['programOfferId'];
    ...
    public function syllabussearch() {
       ...
       $data['syllabus'] = 'active';
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/syllabus/syllabussearch'); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
        $this->load->view('system_path/jsquery'); // footer & script link
    }
          ...
          $data = $this->input->post('data', TRUE);
            ...
            if (!empty($data['programOfferId'])) {
                ...
                if (!empty($data['allsyllabuslist'])) {
                        ...
                        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
                        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
                        $this->load->view('system_path/admin/syllabus/syllabuslist'); // ...........body content page...........
                        $this->load->view('system_path/admin/common/footer'); // footer & script link
                        $this->load->view('system_path/jsquery'); // footer & script link
                } else {
                    ...
                    redirect(admin_Url() . "/syllabus/syllabussearch");
                }
            } else {
                $sdata['errormessage'] = 'Inserted Enrollment Information is not offer yet';
                $this->session->set_userdata($sdata);
    ...
    public function viewsyllabus($id) {
        if ($id != Null) {
            ...
            if (!empty($data['editData'])) {
                ...
                $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
                $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
                $this->load->view('system_path/admin/syllabus/viewsyllabus'); // ...........body content page...........
                $this->load->view('system_path/admin/common/footer'); // footer & script link
            } else {
    ...
    public function editsyllebus($id) {
        if ($id != Null) {
            ...
            if (!empty($data['editData'])) {
                ...
                $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
                $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
                $this->load->view('system_path/admin/syllabus/editsyllabus'); // ...........body content page...........
                $this->load->view('system_path/admin/common/footer'); // footer & script link
...
//        print_r($yes_upload);exit;
    ...
    public function deletesyllabus($id) {
        ...
        $sdata['errormessage'] = 'Syllabus information deleted';
        $this->session->set_userdata($sdata);
        redirect(admin_Url() . "/syllabus/syllabussearch");
    }
