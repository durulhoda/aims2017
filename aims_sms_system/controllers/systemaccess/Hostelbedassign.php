...
class HostelBedAssign extends MY_Controller {
    ...
    public function index() {
       ...
       $data['hostelbedassignlist'] = $this->HostelBedAssignModleAdmin->gethostelBedAssignlist();
        ...
        $this->load->view('system_path/admin/hostelbedassign/index', $data); // ...........body content page...........
    ...
    public function inserthostelbedassign() {
        ...
        if ($this->form_validation->run() == FALSE) {
            redirect(admin_Url() . "/hostelbedassign/index");
        } else {
    ...
    public function hostelBedAssignlist() {
        ...
        $this->load->view('templates/admin/hostelbedassign/viewhostelbedassignlist', $data);
    ...
    public function edithostelBedAssign($id) {
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/hostelbedassign/editbedassaign', $data); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
    }
