...
class Financehead  extends MY_Controller{
    ...
    public function index(){
        ...
        $this->load->view('system_path/admin/finance/index', $data); // ...........body content page...........
...
//                    redirect(base_url('admin/campus'));
            redirect(admin_Url()."/financehead");
        } else {
    ...
    public function listfinancehead() {
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/finance/headcatlist'); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
        //$this->load->view('system_path/jsquery'); // footer & script link
    }
    ...
    public function editfinancehead($id) {
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/finance/editheadlist'); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
    }
    ...
    public function updatefinancehead($id) {
            ...
            if (!$result) {
               ...
               redirect(admin_Url(). "/financehead/listfinancehead");
            } else {
                $sdata['errormessage'] = 'Duplicate Entry Found!';
                $this->session->set_userdata($sdata);
    ...
    public function finance(){
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/finance/add_transaction'); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
       ...
       $this->load->helper(array('form', 'url'));
		...
		else
		{
            ...
            if(empty($data['financeHead']) )
            {
                ...
                $this->session->set_userdata($sdata);
                redirect(admin_Url(). "/financehead/finance");
            }
            else{
    ...
    public function financehistory(){
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/finance/transaction_list'); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
        ...
        public function financesearch() {
          ...
          //   print_r( $data['from_date']); die();
            ...
            //   print_r( $data); die();
                ...
                $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
                $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
                $this->load->view('system_path/admin/finance/transaction_list',$data); // ...........body content page...........
                $this->load->view('system_path/admin/common/footer'); // footer & script link
            } else {
      ...
      //  print_r($data); die();
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/finance/editfinance'); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
    }
