...
class HostelRent extends MY_Controller {
    ...
    public function index() {
        ...
        $this->load->view('system_path/admin/hostelbedrent/index', $data); // ...........body content page...........
    ...
    public function inserthostelrent() {
        ...
        if ($this->form_validation->run() == FALSE) {
                redirect(admin_Url() . "/hostelrent/index");
        } else {
    ...
    public function hostelRentlist() {
        ...
        $this->load->view('templates/admin/hostelrent/viewhostelrentlist', $data);
    ...
    public function edithostelRent($id) {
        ...
        $this->load->view('system_path/admin/common/side_menu', $data); // side bar menu
        $this->load->view('system_path/admin/common/top_menu', $data); // top bar menu
        $this->load->view('system_path/admin/hostelbedrent/edithostelrent', $data); // ...........body content page...........
        $this->load->view('system_path/admin/common/footer'); // footer & script link
    }
